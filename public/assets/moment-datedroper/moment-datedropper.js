/**
 * Created by hamidreza on 9/28/16.
 */
    ...
    $.fn.dateDropper = function (options) {
        return $(this).each(function () {
            ...
            if ($(this).is('input') && $(this).attr('type') == "text") {
                ...
                var
                    t_y_cur = parsePersian(new moment().format("jYYYY")),
                    t_d_cur = parsePersian(new moment().format("jDD")),
                    t_m_cur = parsePersian(new moment().format("jMM"));
                var
                    _dd_m,
                    _dd_d,
                    _dd_y,
                ...
                var _structure = '<div class="dd-w dd-init" id="dd-w-' + _dd_id + '">' +
                ...
                var
                    _dd_init = function () {
                        ...
                        _dd.find('.dd-d li').each(function (index, element) {
                            ...
                            var
                                ...
                                _d = new moment((_dd_m + "/" + _d + "/" + _dd_y)).day();
                            // console.log(_d);
                    ...
                    _dd_submit = function () {
                        ...
                        if (_dd_settings.lock) {
                            ...
                            var
                                d1 = moment(t_y_cur + "-" + (t_m_cur ) + "-" + t_d_cur) / 1000,
                                d2 = moment(_dd_y + "-" + _dd_m + "-" + _dd_d) / 1000;
                        ...
                        var
                            x = new moment(_dd_m + "/" + _dd_d + "/" + _dd_y).day();
                        // x = x.getDay();
                    ...
                    _dd_construct = function () {
                            ...
                            if (_dd_el.hasClass('dd-s-b-m') || _dd_el.hasClass('dd-s-b-d')) {
                                ...
                                if (_dd_el.hasClass('dd-s-b-m')) {
                                    ...
                                    for (var i = i_min; i < i_max; i++) {
                                        ...
                                        _dd_el.find('ul')
                                            .append('<li data-id="' + (i + 1) + '">' + mn[i] + '<span>' + _dd_0(i + 1) + '</span></li>');
                        ...
                        _dd.find('.dd-b').each(function (index, element) {
                            ...
                            if (_dd_el.hasClass('dd-m')) {
                                ...
                                for (var i = 0; i < 12; i++) {
                                    _dd_el.find('ul').append('<li data-id="' + (i + 1) + '">' + mn[i] + '</li>');
                                }
